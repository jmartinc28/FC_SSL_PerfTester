...
docker run -it --rm \
  ...
  -e VPNADDR=fortipanama.fortiddns.com:443 \
  -e VPNUSER=vpnuser \
  -e VPNPASS=VPNpassw0rd \
...
#Run
screen -d -m docker run -it --rm   --privileged   --net fortinet  -e VPNADDR=10.20.28.2:10443   -e VPNUSER=vpnuser   -e VPNPASS=VPNpassw0rd   -e VPNTIMEOUT=15 -e IPERFPORT=5201 fc_perf_tst:0.1
